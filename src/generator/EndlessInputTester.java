...
public class EndlessInputTester {
    ...
    private static int levelForTest = 5;
    private static long timeLimit = 15000;
    private static String outputFile = "examples/level_" + levelForTest + "/output_lvl" + levelForTest + ".txt";
    public static void main(String[] args) throws IOException {
        ...
        while (num<num_file)
        {
            String newInputFile = "examples/level_" + levelForTest + "/input_lvl" + levelForTest + "_" + num + ".txt";
            num++;
            //Your test method here!!!
            System.out.println("Endless input files testing start: ");
            ProblemSpec ps = new ProblemSpec(newInputFile);
//            YOURMETHOD run = new YOURMETHOD(levelForTest,newInputFile, outputFile, timeLimit,ps);
//            if (YOUR PASSED LOGIC)){
//                passed++;
//            System.out.println("Passed!!   "+passed+"  /  "+num);}
//            else
//                System.out.println("Fail!!     "+passed+"  /  "+num);
